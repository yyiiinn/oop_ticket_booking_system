...
public class EventController {
  ...
  public ResponseEntity<List<Map<String, Object>>> getViewEvents() {
   ...
   for (Event e : eventList){
      ...
      List<Seat> tempList = seatRepository.findSeatByEventId(e.getId());
      int noOfTickets = 0;
      for (Seat s : tempList){
          noOfTickets+= s.getNumberOfSeats();
      }
      ...
      rowMap.put("imageUrl", e.getImage());
      ...
      rowMap.put("cancellationCost", e.getCancellationFee());
